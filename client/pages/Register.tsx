...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-between bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-10">
      {/* Left Side - Logo */}
      <div className="hidden md:flex flex-col items-center justify-center w-1/2">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400 text-center max-w-md">
          Create your account and get started with Tanish Info Services.
        </p>
      </div>

      {/* Right Side - Register Form */}
      <div className="w-full md:w-1/2 max-w-md mr-24">
        ...
        {/* <div className="mt-8 text-center text-xs text-gray-500">
          <p>© 2024 Tanish. All rights reserved.</p>
